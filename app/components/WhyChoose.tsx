export default function WhyChoose() {
  const items = [
    "Licensed and insured in the DMV",
      ...
      <div className="section py-12">
        ...
        <ul className="mt-6 grid sm:grid-cols-2 lg:grid-cols-3 gap-4 text-slate-800">
          {items.map((t) => (
            ...
            >
              <span className="mt-1 inline-flex h-6 w-6 items-center justify-center rounded-full bg-brand-primary-dark text-white text-xs font-bold flex-shrink-0">
                ✓
              </span>
